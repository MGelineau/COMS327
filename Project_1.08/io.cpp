...
void io_choose_pokemon()
{
  ...
  Pokemon *poke2 = new Pokemon(1);
  Pokemon *poke3 = new Pokemon(1);

  mvprintw(0, 0, "Which poor creature will you keep in a ball for eternity: ");
  mvprintw(1, 3, "1: %s", poke1->getPokemon());
  mvprintw(2, 3, "2: %s", poke2->getPokemon());
  mvprintw(3, 3, "3: %s", poke3->getPokemon());
